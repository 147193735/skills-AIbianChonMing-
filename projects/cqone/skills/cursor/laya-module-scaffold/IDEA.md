...
| Program | `node` |
| Arguments | `"C:\myGit\skills-AIbianChonMing-\projects\cqone\skills\cursor\laya-module-scaffold\scripts\scaffold-module.js" $Prompt$ --biz --standard --project $ProjectFileDir$` |
