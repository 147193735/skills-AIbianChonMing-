...
4. 运行脚手架（路径相对于本 skill 目录）：

```bash
node projects/cqone/skills/cursor/laya-module-scaffold/scripts/scaffold-module.js <moduleName> --biz --standard --project <项目根>
```

示例：

```bash
node projects/cqone/skills/cursor/laya-module-scaffold/scripts/scaffold-module.js bag --biz --standard --project C:/myPro/cqone
node projects/cqone/skills/cursor/laya-module-scaffold/scripts/scaffold-module.js treasureVault --acts --full --project C:/myPro/cqone --dry-run
```
...
```powershell
powershell -ExecutionPolicy Bypass -File projects/cqone/skills/cursor/laya-module-scaffold/scripts/install-idea-templates.ps1
```
