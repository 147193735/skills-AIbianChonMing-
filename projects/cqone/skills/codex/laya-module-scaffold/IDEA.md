...
| Program | `node` |
| Arguments | `"C:\myGit\skills-AIbianChonMing-\projects\cqone\skills\codex\laya-module-scaffold\scripts\scaffold-module.js" $Prompt$ --biz --standard --project $ProjectFileDir$` |
